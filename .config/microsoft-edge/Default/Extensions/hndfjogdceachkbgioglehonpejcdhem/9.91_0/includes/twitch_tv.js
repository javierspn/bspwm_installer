!function(e) {
    ...
    99: function(e, t, n) {
        "use strict";
        n.r(t);
        var r = n(0), o = n(15), a = n(10), i = n(8), s = n(6), c = n(16), l = n(4), d = n(22), u = n(39);
        var p = function(e) {
            return function(e) {
                const t = {
        ...
        }, h = n(28), f = n(5), v = n(11), g = n(7);
        const b = Object(s.a)("twitch");
        let m = void 0;
        class y {
            constructor() {
            ...
            start() {
                b.log("start"), r.a.callFn("getPreferences").then(e => {
                    m = Object(v.a)({
                        preferences: e
            ...
            onFoundToolbar(e) {
                ...
                if (/videos\/\d+/.test(location.href)) t.onClick = this.handleDownloadStream.bind(this); else {
                    if (!/\/clip\//.test(location.href)) return void b.error("media type not found");
            ...
            handleDownloadStream(e) {
                ...
                const t = location.href.match(/videos\/(\d+)/), n = t && t[1] ? t[1] : void 0, r = this.getVideoName();
                return p(n).then(e => {
                    ...
                    b.error("handleDownloadStream err", t), e.target && (e.target.style.opacity = .3, 
                    e.target.title = "An error has occurred");
                });
            }
            handleDownloadClip(e) {
                e.preventDefault(), e.stopPropagation(), Object(g.a)({
                    category: "download",
                    subcategory: "tw",
                    event: "video"
                });
            ...
            changeActive(e) {
                b.log("change active", e), this.isActive = e ? 1 : 0, this.isActive ? this.start() : this._unmount && this._unmount();
            }
            _bindEvents() {
                if (this._hasEvents) return void b.log("bind events skip");
                this._hasEvents = !0;
                const e = (() => {
                    const e = [];
            ...
            _bindMutationWatcher() {
                b.log("_bindMutationWatcher call"), this.observer && (this.observer.stop(), this.observer.queries.forEach(e => {
                    let {css: t} = e;
                    document.querySelectorAll(t).forEach(e => (e => e.dataset.sfLock = "")(e));
                })), this.observer = new i.a({
                    queries: [ {
                        is: "added",
                        css: 'div[data-target="channel-header-right"] > div > div > div > div:nth-child(1)',
                        callback: e => {
                            let {added: t} = e;
                            return t.forEach(e => {
                                var t, n;
