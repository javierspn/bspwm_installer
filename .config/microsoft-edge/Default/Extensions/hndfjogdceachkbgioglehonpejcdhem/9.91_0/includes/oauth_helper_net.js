!function(e) {
    function t(t) {
        for (var o, i, c = t[0], l = t[1], s = t[2], f = 0, p = []; f < c.length; f++) i = c[f], 
    ...
    97: function(e, t, r) {
        "use strict";
        r.r(t);
        var o = r(0), n = r(29), a = r(6), i = r(43);
        var c = e => new Promise(t => o.a.storage.set(e, t));
        ...
        }).catch(e => l.error(e)), /helper-pro\?force-activate=100/.test(location.href) && c({
            helper_pro_force: !0
        }), /helper-pro\?force-deactivate=100/.test(location.href) && c({
            helper_pro_force: !1
