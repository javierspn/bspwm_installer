!function(e) {
    ...
    89: function(e, t, n) {
        "use strict";
        n.r(t);
        var o = n(0), r = n(11), a = n(10), i = n(27), s = (n(26), n(18)), u = n(9), c = n(14), l = n(3), d = n(1), f = n(15), p = n(8);
        f.a.isSingle() && Object(a.b)("rutube", (function(e, t) {
            ...
            o.a.onMessage.addListener((function(t, n, o) {
                ...
                if ("updatePreferences" !== t.action) {
                    if (f) return "updateLinks" === t.action ? b.updateLinks() : void 0;
            ...
            const b = {
                ...
                contextMenu: null,
                run() {
                    if (f = 1, h) return b.frame();
                    p.a.isAvailable() && b.mutationMode.enable();
                },
                ...
                insertDownloadLink(e) {
                    ...
                    const u = d.a.create("a", {
                        ...
                        on: [ [ "click", function(t) {
                            ...
                            b.contextMenu && b.contextMenu.isShow) return void b.hideMenu();
                            const r = n.popupMenu.prepareLinks.rutube(i());
                            b.contextMenu = n.popupMenu.quickInsert(this, r, "sf-popupMenu", {
                    ...
                    l.a.onRemoveEvent(u, b.hideMenu), e.insertAdjacentElement("afterbegin", u);
                },
                frame() {
                    var e = this, t = n.frameMenu.getBtn({
                        ...
                        on: [ [ "click", function(o) {
                            if (o.preventDefault(), o.stopPropagation(), e.contextMenu && e.contextMenu.isShow) e.hideMenu(); else {
                                var r = n.popupMenu.prepareLinks.rutube(location.href);
                                e.contextMenu = n.frameMenu.getMenu(this, r, "sf-frame-menu", {
